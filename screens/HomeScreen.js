...
export default class HomeScreen extends React.Component {
  ...
  render() {
    ...
    var number = Math.floor(Math.random() * quoteArray.length);
    const renderNavigationView = () => (
      <View
        style={{
          flex: 1,
          backgroundColor: '#267f75',
          alignItems: 'center',
          justifyContent: 'center',
        }}>
        <Text style={styles.quoteText}>{quoteArray[number]}</Text>
    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <Card>
            <Card.Media  
              image={<Image source={require('../assets/images/search.png')} />}
              overlay  
            />
            <Card.Body>          
              <Text style={styles.helpLinkText}>Based on real-time weather statistics, we will recommend the most suitable sports for you!</Text>
            </Card.Body>
            <Card.Actions position="right">                                          
              <Button  text="Start searching" onPress={this._goToScreen('links')}/>
            </Card.Actions>
          </Card>
          <Card>   
            <Card.Media
              image={<Image source={require('../assets/images/sports.png')} />}
              overlay
            />
            <Card.Body>
              <Text style={styles.helpLinkText}>Not sure where to go for sports? Check out public facilities in our little red dot!</Text>
            </Card.Body>
            <Card.Actions position="right">
              <Button color="#841004" value="Have a look" onPress={this._goToScreen('facilities')}/>
            </Card.Actions>
          </Card>
          <Card>
            <Card.Media  
              image={<Image source={require('../assets/images/PUB.png')} />}
              overlay
            />
            <Card.Body>
              <Text style={styles.helpLinkText}>Some of the school facilities are also open during weekends for your use!</Text>
            </Card.Body>
            <Card.Actions position="right">
              <Button color="#841004" value="Go search" onPress={this._goToScreen('dus')}/>
            </Card.Actions>
          </Card>
  ...
  getQuote(){
      ...
      var quoteNumber = 1;
      //var quoteNumber = this.randomNumber(quoteArray.length);
